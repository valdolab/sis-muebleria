...
-- Tiempo de generación: 22-01-2023 a las 23:30:31
...
INSERT INTO `movimiento` (`idmovimiento`, `salida`, `fecha`, `abono`, `descuento`, `recargo`, `saldo_al_momento`, `dias_atraso`, `creado_en`) VALUES
('24038858-98dd-11ed-93c0-d481d7c3a9ad', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-02-18', 100, 0, 0, 2469, 0, '2023-01-20 16:11:47'),
('31c60fe9-98d8-11ed-93c0-d481d7c3a9ad', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-01-22', 400, 0, 0, 2219, 0, '2023-01-20 15:36:23'),
('80a5ad71-9905-11ed-9ad8-d481d7c3a9ad', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-03-16', 0, 0, 0, 2469, 0, '2023-01-20 21:00:43'),
('a4996ef0-98fd-11ed-9ad8-d481d7c3a9ad', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-03-20', 100, 0, 0, 2369, 0, '2023-01-20 20:04:27'),
('c99e35ac-9758-11ed-b47f-d481d7c3a9ad', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-01-20', 200, 0, 0, 3519, 0, '2023-01-18 17:51:51'),
('e45b4d7c-98d9-11ed-93c0-d481d7c3a9ad', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-02-02', 300, 0, 0, 2619, 0, '2023-01-20 15:48:32'),
('f03bc0d4-98d9-11ed-93c0-d481d7c3a9ad', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-02-01', 50, 0, 0, 2569, 0, '2023-01-20 15:48:52'),
('fd25a5c3-9758-11ed-b47f-d481d7c3a9ad', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-01-21', 200, 0, 0, 3319, 0, '2023-01-18 17:53:17'),
('qw123409-12sd-11ed-ad48-d481d7c3k7er', 'ce205052-95ca-11ed-ad48-d481d7c3a9ad', '2023-01-16', 498, 0, 0, 3719, 0, '2023-01-16 23:01:13');
...
--
-- Estructura de tabla para la tabla `salida_modaldad_pago_actual`
--

DROP TABLE IF EXISTS `salida_modaldad_pago_actual`;
CREATE TABLE IF NOT EXISTS `salida_modaldad_pago_actual` (
  `idsalida_modaldad_pago_actual` char(36) COLLATE utf8_spanish_ci NOT NULL,
  `salida` char(36) COLLATE utf8_spanish_ci NOT NULL,
  `modalidad_actual` char(36) COLLATE utf8_spanish_ci NOT NULL,
  ...
  `creado_en` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`idsalida_modaldad_pago_actual`),
  KEY `modalidad_actual_de_la_salida` (`salida`),
  KEY `modalidad_actual` (`modalidad_actual`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
-- Filtros para la tabla `salida_modaldad_pago_actual`
--
ALTER TABLE `salida_modaldad_pago_actual`
  ADD CONSTRAINT `modalidad_actual` FOREIGN KEY (`modalidad_actual`) REFERENCES `modalidad_pago` (`idmodalidad_pago`),
