...
-- Tiempo de generación: 28-06-2023 a las 19:09:12
...
CREATE TABLE `categoria` (
  ...
  `atr1` varchar(100) DEFAULT NULL,
  `atr2` varchar(100) DEFAULT NULL,
  `atr3` varchar(100) DEFAULT NULL,
  `atr4` varchar(100) DEFAULT NULL,
  `atr5` varchar(100) DEFAULT NULL,
...
CREATE TABLE `cliente` (
  `idcliente` char(32) NOT NULL,
  `nombre_cliente` varchar(100) NOT NULL,
  `zona` char(36) NOT NULL,
  `domicilio_cliente` varchar(500) DEFAULT NULL,
  `subzona` char(36) NOT NULL,
  `tel1_cliente` varchar(20) DEFAULT NULL,
  ...
  `trabajo_cliente` varchar(100) DEFAULT NULL,
  `puesto_cliente` varchar(100) DEFAULT NULL,
  `direccion_trabajo_cliente` varchar(400) DEFAULT NULL,
  ...
  `tipo_ingresos_cliente` varchar(20) NOT NULL DEFAULT 'Quincenal',
  `nombre_conyugue_cliente` varchar(100) DEFAULT NULL,
  `antiguedadA_vinculo` int(11) DEFAULT NULL,
  `antiguedadM_vinculo` int(11) DEFAULT NULL,
  `trabajo_conyugue` varchar(100) DEFAULT NULL,
  `puesto_conyugue` varchar(100) DEFAULT NULL,
  `ingreso_mensual_conyugue` double DEFAULT NULL,
  `direccion_trabajo_conyugue` varchar(400) DEFAULT NULL,
  `tel_conyugue` varchar(20) DEFAULT NULL,
  `tipo_vivienda_cliente` varchar(20) NOT NULL DEFAULT 'Propia',
  `edad_residencia` int(11) NOT NULL DEFAULT 0,
  `renta_mensual` double NOT NULL DEFAULT 0,
  `ndependientes` int(11) NOT NULL DEFAULT 0,
  `nombre_aval` varchar(100) DEFAULT NULL,
  `tel_aval` varchar(20) DEFAULT NULL,
  `domicilio_aval` varchar(500) DEFAULT NULL,
  `trabajo_aval` varchar(100) DEFAULT NULL,
  `puesto_aval` varchar(100) DEFAULT NULL,
  `ingreso_mensual_aval` double DEFAULT NULL,
  `nombre_conyugue_aval` varchar(100) DEFAULT NULL,
...
CREATE TABLE `compra_tipo` (
  `idtipo_compra` char(36) NOT NULL,
...
CREATE TABLE `configuracion` (
  ...
  `valor_char` varchar(50) DEFAULT NULL,
...
CREATE TABLE `entrada` (
  `identrada` char(36) NOT NULL,
  `comprador` char(36) NOT NULL,
  `proveedor` char(36) NOT NULL,
  `tel_proveedor` varchar(20) DEFAULT NULL,
  `fecha` date NOT NULL,
  `folio_compra` varchar(100) DEFAULT NULL,
  `tipo_compra` char(36) NOT NULL,
  `sucursal` int(11) NOT NULL,
  `almacen` char(36) NOT NULL,
...
CREATE TABLE `entrada_productos` (
  `identrada_producto` char(36) NOT NULL,
  `entrada` char(36) NOT NULL,
...
CREATE TABLE `entrada_productos_serie` (
  `identrada_producto_serie` char(36) NOT NULL,
  `entrada_productos` char(36) NOT NULL,
  `entrada` char(36) NOT NULL,
  `producto` char(36) NOT NULL,
  `almacen_actual` char(36) DEFAULT NULL,
...
CREATE TABLE `modalidad_pago` (
  `idmodalidad_pago` char(36) NOT NULL,
...
CREATE TABLE `movimiento_atrasos` (
  `idmovimiento_atraso` char(36) NOT NULL,
  `salida` char(36) NOT NULL,
  `tipo_periodo_atraso` varchar(100) NOT NULL,
...
CREATE TABLE `permiso_usuario` (
  ...
  `permiso_idusuario` char(36) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `producto` (
  ...
  `categoria` char(36) DEFAULT NULL,
  `subcategoria` char(36) DEFAULT NULL,
  `descripcion` text DEFAULT NULL,
  `serializado` tinyint(1) NOT NULL,
  `atr1_producto` varchar(100) DEFAULT NULL,
  `atr2_producto` varchar(100) DEFAULT NULL,
  `atr3_producto` varchar(100) DEFAULT NULL,
  `atr4_producto` varchar(100) DEFAULT NULL,
  `atr5_producto` varchar(100) DEFAULT NULL,
...
('29ba1edf-f8dc-11ed-a2bc-feed01180002', 'b4f9567e-f6a5-11ed-a2bc-feed01180002', '38e422200245116b5cb324565d8de73f', '2022-07-14', 1, 'MAT-0000001', 1, '2651952b-2977-11ed-a437-d481d7c3a9ad', 'quincenal', 16, 400, '2022-08-01', NULL, 1, 16, NULL, 516, 5517.24, 882.76, 6400, 0, 6400, 0, 0, "NOTAS AQUI", NULL, 0, '2023-05-22 20:06:39');
...
CREATE TABLE `salida_acuerdo` (
  `idsalida_acuerdo` char(36) NOT NULL,
  `salida` char(36) NOT NULL,
  `modalidad_actual` varchar(20) NOT NULL,
  `dia_semanal` varchar(20) DEFAULT NULL,
...
CREATE TABLE `salida_productos` (
  `idsalida_producto` char(36) NOT NULL,
  `salida` char(36) NOT NULL,
  `producto` char(36) NOT NULL,
  `cantidad` int(11) NOT NULL DEFAULT 1,
...
CREATE TABLE `salida_productos_origen` (
  `idsalida_producto_origen` char(36) NOT NULL,
  `salida_productos` char(36) NOT NULL,
  `salida` char(36) NOT NULL,
  `producto` char(36) NOT NULL,
  `serie_origen` char(36) DEFAULT NULL,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `salida_usuarios_a_cargo` (
  `idsalida_usuarios_a_cargo` char(36) NOT NULL,
  `salida` char(36) NOT NULL,
  `usuario_admin_a_cargo` char(36) NOT NULL,
  `vendedor_a_cargo` char(36) NOT NULL,
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `subcategoria` (
  `idsubcategoria` char(36) NOT NULL,
  `nombre` varchar(100) NOT NULL,
...
CREATE TABLE `sucursales` (
  ...
  `sucursales` varchar(300) NOT NULL,
  `descripcion` text DEFAULT NULL,
...
CREATE TABLE `sucursal_usuario` (
  ...
  `sucursal_idusuario` char(36) NOT NULL COMMENT 'corresponde',
...
ALTER TABLE `entrada`
  ...
  ADD KEY `compra_de_tipo` (`tipo_compra`),
  ADD KEY `de_la_sucursal` (`sucursal`),
  ADD KEY `del_almacen` (`almacen`),
  ADD KEY `comprado_del_proveedor` (`proveedor`),
  ADD KEY `lo_compro` (`comprador`);

--
-- Indices de la tabla `entrada_productos`
--
ALTER TABLE `entrada_productos`
  ADD PRIMARY KEY (`identrada_producto`),
  ADD KEY `pertenece_a_entrada` (`entrada`),
  ADD KEY `es_del_producto` (`producto`);

--
-- Indices de la tabla `entrada_productos_serie`
--
ALTER TABLE `entrada_productos_serie`
  ADD PRIMARY KEY (`identrada_producto_serie`),
  ADD KEY `de_la_entrada_producto` (`entrada_productos`),
  ADD KEY `del_producto` (`producto`),
  ADD KEY `pertenece_a_la_entrada` (`entrada`),
  ADD KEY `esta_en_el_almacen` (`almacen_actual`);
...
ALTER TABLE `movimiento`
  ...
  ADD KEY `movimieto_de_la_salida` (`salida`);

--
-- Indices de la tabla `movimiento_atrasos`
--
ALTER TABLE `movimiento_atrasos`
  ADD PRIMARY KEY (`idmovimiento_atraso`),
  ADD KEY `atraso_de_la_salida` (`salida`);
...
ALTER TABLE `salida`
  ...
  ADD KEY `es del folio` (`documento`);

--
-- Indices de la tabla `salida_acuerdo`
--
ALTER TABLE `salida_acuerdo`
  ADD PRIMARY KEY (`idsalida_acuerdo`),
  ADD KEY `acuerdo_actual_de_la_salida` (`salida`) USING BTREE;
...
--
-- Indices de la tabla `salida_productos_origen`
--
ALTER TABLE `salida_productos_origen`
  ADD PRIMARY KEY (`idsalida_producto_origen`),
  ADD KEY `es_de_la_salida_productos` (`salida_productos`),
  ADD KEY `es_de_la_salida` (`salida`),
  ADD KEY `es_de_el_producto` (`producto`),
  ADD KEY `salida_de_origen` (`serie_origen`);

--
-- Indices de la tabla `salida_usuarios_a_cargo`
--
ALTER TABLE `salida_usuarios_a_cargo`
  ADD PRIMARY KEY (`idsalida_usuarios_a_cargo`),
  ADD KEY `a_cargo_de_la_salida` (`salida`),
  ADD KEY `persona_admin_a_cargo` (`usuario_admin_a_cargo`),
  ADD KEY `vendedor_a_cargo` (`vendedor_a_cargo`);
...
--
ALTER TABLE `referencias_cliente`
  MODIFY `idreferencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=412;
...
--
ALTER TABLE `sucursal_usuario`
  MODIFY `idsucursal_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `usuario`
--
ALTER TABLE `usuario`
  MODIFY `no_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
